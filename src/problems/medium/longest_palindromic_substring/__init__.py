...
def _auto_import_functions():
    ...
    try:
        ...
        from .longest_palindromic_substring import longest_palindromic_substring, longest_palindromic_substring_brute_force, longest_palindromic_substring_optimized
        return ['longest_palindromic_substring', 'longest_palindromic_substring_brute_force', 'longest_palindromic_substring_optimized']
