...
def _auto_import_functions():
    ...
    try:
        ...
        from .accounts_merge import accounts_merge, accounts_merge_brute_force, accounts_merge_optimized
        return ['accounts_merge', 'accounts_merge_brute_force', 'accounts_merge_optimized']
