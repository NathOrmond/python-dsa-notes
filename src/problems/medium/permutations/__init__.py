...
def _auto_import_functions():
    ...
    try:
        ...
        from .permutations import permutations, permutations_brute_force, permutations_optimized
        return ['permutations', 'permutations_brute_force', 'permutations_optimized']
