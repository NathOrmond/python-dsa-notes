...
def permutations(nums: List[int]) -> int:
    """
    Main solution function for permutations.
    ...
    return permutations_optimized(nums)


def permutations_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for permutations.
...
def permutations_optimized(nums: List[int]) -> int:
    """
    Optimized approach for permutations.
