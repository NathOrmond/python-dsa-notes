...
def _auto_import_functions():
    ...
    try:
        ...
        from .spiral_matrix import spiral_matrix, spiral_matrix_brute_force, spiral_matrix_optimized
        return ['spiral_matrix', 'spiral_matrix_brute_force', 'spiral_matrix_optimized']
