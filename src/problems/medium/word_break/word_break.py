...
def word_break(nums: List[int]) -> int:
    """
    Main solution function for word break.
    ...
    return word_break_optimized(nums)


def word_break_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for word break.
...
def word_break_optimized(nums: List[int]) -> int:
    """
    Optimized approach for word break.
