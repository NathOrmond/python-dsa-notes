...
def _auto_import_functions():
    ...
    try:
        ...
        from .task_scheduler import task_scheduler, task_scheduler_brute_force, task_scheduler_optimized
        return ['task_scheduler', 'task_scheduler_brute_force', 'task_scheduler_optimized']
