...
def task_scheduler(nums: List[int]) -> int:
    """
    Main solution function for task scheduler.
    ...
    return task_scheduler_optimized(nums)


def task_scheduler_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for task scheduler.
...
def task_scheduler_optimized(nums: List[int]) -> int:
    """
    Optimized approach for task scheduler.
