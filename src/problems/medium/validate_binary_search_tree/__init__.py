...
def _auto_import_functions():
    ...
    try:
        ...
        from .validate_binary_search_tree import validate_binary_search_tree, validate_binary_search_tree_brute_force, validate_binary_search_tree_optimized
        return ['validate_binary_search_tree', 'validate_binary_search_tree_brute_force', 'validate_binary_search_tree_optimized']
