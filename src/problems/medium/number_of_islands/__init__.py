...
def _auto_import_functions():
    ...
    try:
        ...
        from .number_of_islands import number_of_islands, number_of_islands_brute_force, number_of_islands_optimized
        return ['number_of_islands', 'number_of_islands_brute_force', 'number_of_islands_optimized']
