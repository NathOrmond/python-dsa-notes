...
def number_of_islands(nums: List[int]) -> int:
    """
    ...
    return number_of_islands_optimized(nums)


def number_of_islands_brute_force(nums: List[int]) -> int:
    """
...
def number_of_islands_optimized(nums: List[int]) -> int:
    """
    Optimized approach for number of islands.
