...
def _auto_import_functions():
    ...
    try:
        ...
        from .search_in_rotated_sorted_array import search_in_rotated_sorted_array, search_in_rotated_sorted_array_brute_force, search_in_rotated_sorted_array_optimized
        return ['search_in_rotated_sorted_array', 'search_in_rotated_sorted_array_brute_force', 'search_in_rotated_sorted_array_optimized']
