...
def search_in_rotated_sorted_array(nums: List[int]) -> int:
    """
    Main solution function for search in rotated sorted array.
    ...
    return search_in_rotated_sorted_array_binary_search(nums)


def search_in_rotated_sorted_array_brute_force(nums: List[int]) -> int:
    """
...
def search_in_rotated_sorted_array_binary_search(nums: List[int]) -> int:
    """
