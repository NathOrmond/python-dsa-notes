...
def _auto_import_functions():
    ...
    try:
        ...
        from .minimum_height_trees import minimum_height_trees, minimum_height_trees_brute_force, minimum_height_trees_optimized
        return ['minimum_height_trees', 'minimum_height_trees_brute_force', 'minimum_height_trees_optimized']
