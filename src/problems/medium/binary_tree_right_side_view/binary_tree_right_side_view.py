...
def binary_tree_right_side_view(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Main solution function for binary tree right side view.
    ...
    return binary_tree_right_side_view_recursive(root)


def binary_tree_right_side_view_brute_force(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Brute force approach for binary tree right side view.
...
def binary_tree_right_side_view_recursive(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Optimized approach for binary tree right side view.
