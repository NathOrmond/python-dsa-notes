...
def _auto_import_functions():
    ...
    try:
        ...
        from .time_based_keyvalue_store import time_based_keyvalue_store, time_based_keyvalue_store_brute_force, time_based_keyvalue_store_optimized
        return ['time_based_keyvalue_store', 'time_based_keyvalue_store_brute_force', 'time_based_keyvalue_store_optimized']
