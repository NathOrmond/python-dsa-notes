...
def longest_substring_without_repeating_characters(s: str) -> int:
    """
    Main solution function for longest substring without repeating characters.
    ...
    return longest_substring_without_repeating_characters_optimized(s)
...
def longest_substring_without_repeating_characters_optimized(s: str) -> int:
    """
    Optimized approach for longest substring without repeating characters.
