...
def _auto_import_functions():
    ...
    try:
        ...
        from .maximum_subarray import maximum_subarray, maximum_subarray_brute_force, maximum_subarray_optimized
        return ['maximum_subarray', 'maximum_subarray_brute_force', 'maximum_subarray_optimized']
