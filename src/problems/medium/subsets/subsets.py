...
def subsets(nums: List[int]) -> int:
    """
    Main solution function for subsets.
    ...
    return subsets_optimized(nums)


def subsets_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for subsets.
...
def subsets_optimized(nums: List[int]) -> int:
    """
    Optimized approach for subsets.
