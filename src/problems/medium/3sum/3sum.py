...
def 3sum(nums: List[int]) -> int:
    """
    Main solution function for 3sum.
    ...
    return 3sum_optimized(nums)


def 3sum_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for 3sum.
...
def 3sum_optimized(nums: List[int]) -> int:
    """
    Optimized approach for 3sum.
