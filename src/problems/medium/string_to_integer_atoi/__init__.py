...
def _auto_import_functions():
    ...
    try:
        ...
        from .string_to_integer_atoi import string_to_integer_atoi, string_to_integer_atoi_brute_force, string_to_integer_atoi_optimized
        return ['string_to_integer_atoi', 'string_to_integer_atoi_brute_force', 'string_to_integer_atoi_optimized']
