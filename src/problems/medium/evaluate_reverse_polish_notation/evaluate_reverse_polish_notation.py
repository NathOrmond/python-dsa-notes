...
def evaluate_reverse_polish_notation(nums: List[int]) -> int:
    """
    Main solution function for evaluate reverse polish notation.
    ...
    return evaluate_reverse_polish_notation_optimized(nums)


def evaluate_reverse_polish_notation_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for evaluate reverse polish notation.
...
def evaluate_reverse_polish_notation_optimized(nums: List[int]) -> int:
    """
    Optimized approach for evaluate reverse polish notation.
