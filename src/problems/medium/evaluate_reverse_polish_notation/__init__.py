...
def _auto_import_functions():
    ...
    try:
        ...
        from .evaluate_reverse_polish_notation import evaluate_reverse_polish_notation, evaluate_reverse_polish_notation_brute_force, evaluate_reverse_polish_notation_optimized
        return ['evaluate_reverse_polish_notation', 'evaluate_reverse_polish_notation_brute_force', 'evaluate_reverse_polish_notation_optimized']
