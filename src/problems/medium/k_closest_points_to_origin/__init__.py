...
def _auto_import_functions():
    ...
    try:
        ...
        from .k_closest_points_to_origin import k_closest_points_to_origin, k_closest_points_to_origin_brute_force, k_closest_points_to_origin_optimized
        return ['k_closest_points_to_origin', 'k_closest_points_to_origin_brute_force', 'k_closest_points_to_origin_optimized']
