...
def course_schedule(nums: List[int]) -> int:
    """
    ...
    return course_schedule_optimized(nums)


def course_schedule_brute_force(nums: List[int]) -> int:
    """
...
def course_schedule_optimized(nums: List[int]) -> int:
    """
    Optimized approach for course schedule.
