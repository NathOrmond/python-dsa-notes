...
def _auto_import_functions():
    ...
    try:
        ...
        from .course_schedule import course_schedule, course_schedule_brute_force, course_schedule_optimized
        return ['course_schedule', 'course_schedule_brute_force', 'course_schedule_optimized']
