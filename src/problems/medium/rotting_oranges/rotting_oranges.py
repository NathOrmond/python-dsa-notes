...
def rotting_oranges(nums: List[int]) -> int:
    """
    Main solution function for rotting oranges.
    ...
    return rotting_oranges_optimized(nums)


def rotting_oranges_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for rotting oranges.
...
def rotting_oranges_optimized(nums: List[int]) -> int:
    """
    Optimized approach for rotting oranges.
