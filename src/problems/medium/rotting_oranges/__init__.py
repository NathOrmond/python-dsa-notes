...
def _auto_import_functions():
    ...
    try:
        ...
        from .rotting_oranges import rotting_oranges, rotting_oranges_brute_force, rotting_oranges_optimized
        return ['rotting_oranges', 'rotting_oranges_brute_force', 'rotting_oranges_optimized']
