...
def _auto_import_functions():
    ...
    try:
        ...
        from .merge_intervals import merge_intervals, merge_intervals_brute_force, merge_intervals_optimized
        return ['merge_intervals', 'merge_intervals_brute_force', 'merge_intervals_optimized']
