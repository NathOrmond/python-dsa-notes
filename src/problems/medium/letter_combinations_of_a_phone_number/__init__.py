...
def _auto_import_functions():
    ...
    try:
        ...
        from .letter_combinations_of_a_phone_number import letter_combinations_of_a_phone_number, letter_combinations_of_a_phone_number_brute_force, letter_combinations_of_a_phone_number_optimized
        return ['letter_combinations_of_a_phone_number', 'letter_combinations_of_a_phone_number_brute_force', 'letter_combinations_of_a_phone_number_optimized']
