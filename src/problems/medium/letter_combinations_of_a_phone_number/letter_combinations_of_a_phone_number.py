...
def letter_combinations_of_a_phone_number(nums: List[int]) -> int:
    """
    Main solution function for letter combinations of a phone number.
    ...
    return letter_combinations_of_a_phone_number_optimized(nums)


def letter_combinations_of_a_phone_number_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for letter combinations of a phone number.
...
def letter_combinations_of_a_phone_number_optimized(nums: List[int]) -> int:
    """
    Optimized approach for letter combinations of a phone number.
