...
def find_all_anagrams_in_a_string(s: str, t: str) -> bool:
    """
    Main solution function for find all anagrams in a string.
    ...
    return find_all_anagrams_in_a_string_two_pointers(s)


def find_all_anagrams_in_a_string_brute_force(s: str, t: str) -> bool:
    """
    Brute force approach for find all anagrams in a string.
...
def find_all_anagrams_in_a_string_two_pointers(s: str, t: str) -> bool:
    """
    Optimized approach for find all anagrams in a string.
