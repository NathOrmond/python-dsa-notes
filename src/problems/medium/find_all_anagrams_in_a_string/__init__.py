...
def _auto_import_functions():
    ...
    try:
        ...
        from .find_all_anagrams_in_a_string import find_all_anagrams_in_a_string, find_all_anagrams_in_a_string_brute_force, find_all_anagrams_in_a_string_optimized
        return ['find_all_anagrams_in_a_string', 'find_all_anagrams_in_a_string_brute_force', 'find_all_anagrams_in_a_string_optimized']
