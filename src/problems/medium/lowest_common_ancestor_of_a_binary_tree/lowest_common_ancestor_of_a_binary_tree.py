...
def lowest_common_ancestor_of_a_binary_tree(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Main solution function for lowest common ancestor of a binary tree.
    ...
    return lowest_common_ancestor_of_a_binary_tree_recursive(root)


def lowest_common_ancestor_of_a_binary_tree_brute_force(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Brute force approach for lowest common ancestor of a binary tree.
...
def lowest_common_ancestor_of_a_binary_tree_recursive(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Optimized approach for lowest common ancestor of a binary tree.
