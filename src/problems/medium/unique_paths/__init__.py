...
def _auto_import_functions():
    ...
    try:
        ...
        from .unique_paths import unique_paths, unique_paths_brute_force, unique_paths_optimized
        return ['unique_paths', 'unique_paths_brute_force', 'unique_paths_optimized']
