...
def _auto_import_functions():
    ...
    try:
        ...
        from .container_with_most_water import container_with_most_water, container_with_most_water_brute_force, container_with_most_water_optimized
        return ['container_with_most_water', 'container_with_most_water_brute_force', 'container_with_most_water_optimized']
