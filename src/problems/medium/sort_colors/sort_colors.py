...
def sort_colors(nums: List[int]) -> int:
    """
    Main solution function for sort colors.
    ...
    return sort_colors_optimized(nums)


def sort_colors_brute_force(nums: List[int]) -> int:
    """
...
def sort_colors_optimized(nums: List[int]) -> int:
    """
    Optimized approach for sort colors.
