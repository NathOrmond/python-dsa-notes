...
def _auto_import_functions():
    ...
    try:
        ...
        from .product_of_array_except_self import product_of_array_except_self, product_of_array_except_self_brute_force, product_of_array_except_self_optimized
        return ['product_of_array_except_self', 'product_of_array_except_self_brute_force', 'product_of_array_except_self_optimized']
