...
def product_of_array_except_self(nums: List[int]) -> int:
    """
    Main solution function for product of array except self.
    ...
    return product_of_array_except_self_optimized(nums)


def product_of_array_except_self_brute_force(nums: List[int]) -> int:
    """
...
def product_of_array_except_self_optimized(nums: List[int]) -> int:
    """
    Optimized approach for product of array except self.
