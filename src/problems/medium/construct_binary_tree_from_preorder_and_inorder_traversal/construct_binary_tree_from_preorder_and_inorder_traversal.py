...
def construct_binary_tree_from_preorder_and_inorder_traversal(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Main solution function for construct binary tree from preorder and inorder traversal.
    ...
    return construct_binary_tree_from_preorder_and_inorder_traversal_recursive(root)


def construct_binary_tree_from_preorder_and_inorder_traversal_brute_force(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
...
def construct_binary_tree_from_preorder_and_inorder_traversal_recursive(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Optimized approach for construct binary tree from preorder and inorder traversal.
