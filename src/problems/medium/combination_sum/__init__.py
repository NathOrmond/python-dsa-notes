...
def _auto_import_functions():
    ...
    try:
        ...
        from .combination_sum import combination_sum, combination_sum_brute_force, combination_sum_optimized
        return ['combination_sum', 'combination_sum_brute_force', 'combination_sum_optimized']
