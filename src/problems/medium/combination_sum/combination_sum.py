...
def combination_sum(nums: List[int]) -> int:
    """
    Main solution function for combination sum.
    ...
    return combination_sum_optimized(nums)


def combination_sum_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for combination sum.
...
def combination_sum_optimized(nums: List[int]) -> int:
    """
    Optimized approach for combination sum.
