...
def insert_interval(nums: List[int]) -> int:
    """
    Main solution function for insert interval.
    ...
    return insert_interval_optimized(nums)


def insert_interval_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for insert interval.
...
def insert_interval_optimized(nums: List[int]) -> int:
    """
    Optimized approach for insert interval.
