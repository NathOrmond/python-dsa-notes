...
def _auto_import_functions():
    ...
    try:
        ...
        from .insert_interval import insert_interval, insert_interval_brute_force, insert_interval_optimized
        return ['insert_interval', 'insert_interval_brute_force', 'insert_interval_optimized']
