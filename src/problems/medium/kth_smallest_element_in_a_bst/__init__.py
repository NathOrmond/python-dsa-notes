...
def _auto_import_functions():
    ...
    try:
        ...
        from .kth_smallest_element_in_a_bst import kth_smallest_element_in_a_bst, kth_smallest_element_in_a_bst_brute_force, kth_smallest_element_in_a_bst_optimized
        return ['kth_smallest_element_in_a_bst', 'kth_smallest_element_in_a_bst_brute_force', 'kth_smallest_element_in_a_bst_optimized']
