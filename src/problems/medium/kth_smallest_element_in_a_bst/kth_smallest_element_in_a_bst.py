...
def kth_smallest_element_in_a_bst(nums: List[int]) -> int:
    """
    Main solution function for kth smallest element in a bst.
    ...
    return kth_smallest_element_in_a_bst_optimized(nums)


def kth_smallest_element_in_a_bst_brute_force(nums: List[int]) -> int:
    """
...
def kth_smallest_element_in_a_bst_optimized(nums: List[int]) -> int:
    """
    Optimized approach for kth smallest element in a bst.
