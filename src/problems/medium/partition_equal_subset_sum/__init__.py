...
def _auto_import_functions():
    ...
    try:
        ...
        from .partition_equal_subset_sum import partition_equal_subset_sum, partition_equal_subset_sum_brute_force, partition_equal_subset_sum_optimized
        return ['partition_equal_subset_sum', 'partition_equal_subset_sum_brute_force', 'partition_equal_subset_sum_optimized']
