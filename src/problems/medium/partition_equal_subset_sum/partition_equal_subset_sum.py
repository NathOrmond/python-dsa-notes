...
def partition_equal_subset_sum(nums: List[int]) -> int:
    """
    Main solution function for partition equal subset sum.
    ...
    return partition_equal_subset_sum_optimized(nums)


def partition_equal_subset_sum_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for partition equal subset sum.
...
def partition_equal_subset_sum_optimized(nums: List[int]) -> int:
    """
    Optimized approach for partition equal subset sum.
