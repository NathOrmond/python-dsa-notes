...
def _auto_import_functions():
    ...
    try:
        ...
        from .find_median_from_data_stream import find_median_from_data_stream, find_median_from_data_stream_brute_force, find_median_from_data_stream_optimized
        return ['find_median_from_data_stream', 'find_median_from_data_stream_brute_force', 'find_median_from_data_stream_optimized']
