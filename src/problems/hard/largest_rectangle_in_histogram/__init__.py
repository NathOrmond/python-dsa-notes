...
def _auto_import_functions():
    ...
    try:
        ...
        from .largest_rectangle_in_histogram import largest_rectangle_in_histogram, largest_rectangle_in_histogram_brute_force, largest_rectangle_in_histogram_optimized
        return ['largest_rectangle_in_histogram', 'largest_rectangle_in_histogram_brute_force', 'largest_rectangle_in_histogram_optimized']
