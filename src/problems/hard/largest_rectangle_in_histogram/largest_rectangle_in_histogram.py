...
def largest_rectangle_in_histogram(nums: List[int]) -> int:
    """
    Main solution function for largest rectangle in histogram.
    ...
    return largest_rectangle_in_histogram_optimized(nums)


def largest_rectangle_in_histogram_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for largest rectangle in histogram.
...
def largest_rectangle_in_histogram_optimized(nums: List[int]) -> int:
    """
    Optimized approach for largest rectangle in histogram.
