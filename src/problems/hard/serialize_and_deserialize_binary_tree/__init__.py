...
def _auto_import_functions():
    ...
    try:
        ...
        from .serialize_and_deserialize_binary_tree import serialize_and_deserialize_binary_tree, serialize_and_deserialize_binary_tree_brute_force, serialize_and_deserialize_binary_tree_optimized
        return ['serialize_and_deserialize_binary_tree', 'serialize_and_deserialize_binary_tree_brute_force', 'serialize_and_deserialize_binary_tree_optimized']
