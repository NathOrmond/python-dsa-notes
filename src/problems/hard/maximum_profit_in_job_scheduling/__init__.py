...
def _auto_import_functions():
    ...
    try:
        ...
        from .maximum_profit_in_job_scheduling import maximum_profit_in_job_scheduling, maximum_profit_in_job_scheduling_brute_force, maximum_profit_in_job_scheduling_optimized
        return ['maximum_profit_in_job_scheduling', 'maximum_profit_in_job_scheduling_brute_force', 'maximum_profit_in_job_scheduling_optimized']
