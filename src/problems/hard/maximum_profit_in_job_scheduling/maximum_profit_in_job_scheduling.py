...
def maximum_profit_in_job_scheduling(nums: List[int]) -> int:
    """
    Main solution function for maximum profit in job scheduling.
    ...
    return maximum_profit_in_job_scheduling_optimized(nums)


def maximum_profit_in_job_scheduling_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for maximum profit in job scheduling.
...
def maximum_profit_in_job_scheduling_optimized(nums: List[int]) -> int:
    """
    Optimized approach for maximum profit in job scheduling.
