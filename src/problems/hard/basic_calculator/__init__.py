...
def _auto_import_functions():
    ...
    try:
        ...
        from .basic_calculator import basic_calculator, basic_calculator_brute_force, basic_calculator_optimized
        return ['basic_calculator', 'basic_calculator_brute_force', 'basic_calculator_optimized']
