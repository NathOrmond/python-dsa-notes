...
def basic_calculator(nums: List[int]) -> int:
    """
    Main solution function for basic calculator.
    ...
    return basic_calculator_optimized(nums)


def basic_calculator_brute_force(nums: List[int]) -> int:
    """
...
def basic_calculator_optimized(nums: List[int]) -> int:
    """
    Optimized approach for basic calculator.
