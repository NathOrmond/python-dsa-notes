...
def word_ladder(nums: List[int]) -> int:
    """
    Main solution function for word ladder.
    ...
    return word_ladder_optimized(nums)


def word_ladder_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for word ladder.
...
def word_ladder_optimized(nums: List[int]) -> int:
    """
    Optimized approach for word ladder.
