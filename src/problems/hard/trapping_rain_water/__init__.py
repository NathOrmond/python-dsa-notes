...
def _auto_import_functions():
    ...
    try:
        ...
        from .trapping_rain_water import trapping_rain_water, trapping_rain_water_brute_force, trapping_rain_water_optimized
        return ['trapping_rain_water', 'trapping_rain_water_brute_force', 'trapping_rain_water_optimized']
