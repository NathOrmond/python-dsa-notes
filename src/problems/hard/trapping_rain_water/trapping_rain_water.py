...
def trapping_rain_water(nums: List[int]) -> int:
    """
    Main solution function for trapping rain water.
    ...
    return trapping_rain_water_optimized(nums)


def trapping_rain_water_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for trapping rain water.
...
def trapping_rain_water_optimized(nums: List[int]) -> int:
    """
    Optimized approach for trapping rain water.
