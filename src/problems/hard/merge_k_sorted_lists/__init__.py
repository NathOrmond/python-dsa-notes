...
def _auto_import_functions():
    ...
    try:
        ...
        from .merge_k_sorted_lists import merge_k_sorted_lists, merge_k_sorted_lists_brute_force, merge_k_sorted_lists_optimized
        return ['merge_k_sorted_lists', 'merge_k_sorted_lists_brute_force', 'merge_k_sorted_lists_optimized']
