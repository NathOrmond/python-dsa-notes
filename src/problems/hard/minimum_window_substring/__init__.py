...
def _auto_import_functions():
    ...
    try:
        ...
        from .minimum_window_substring import minimum_window_substring, minimum_window_substring_brute_force, minimum_window_substring_optimized
        return ['minimum_window_substring', 'minimum_window_substring_brute_force', 'minimum_window_substring_optimized']
