...
def _auto_import_functions():
    ...
    try:
        ...
        from .maximum_depth_of_binary_tree import maximum_depth_of_binary_tree, maximum_depth_of_binary_tree_brute_force, maximum_depth_of_binary_tree_optimized
        return ['maximum_depth_of_binary_tree', 'maximum_depth_of_binary_tree_brute_force', 'maximum_depth_of_binary_tree_optimized']
