...
def maximum_depth_of_binary_tree(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Main solution function for maximum depth of binary tree.
    ...
    return maximum_depth_of_binary_tree_recursive(root)


def maximum_depth_of_binary_tree_brute_force(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Brute force approach for maximum depth of binary tree.
...
def maximum_depth_of_binary_tree_recursive(root: Optional[TreeNode]) -> Optional[TreeNode]:
    """
    Optimized approach for maximum depth of binary tree.
