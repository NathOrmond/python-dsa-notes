...
def _auto_import_functions():
    ...
    try:
        ...
        from .longest_palindrome import longest_palindrome, longest_palindrome_brute_force, longest_palindrome_optimized
        return ['longest_palindrome', 'longest_palindrome_brute_force', 'longest_palindrome_optimized']
