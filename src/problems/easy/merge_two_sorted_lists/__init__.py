...
def _auto_import_functions():
    ...
    try:
        ...
        from .merge_two_sorted_lists import merge_two_sorted_lists, merge_two_sorted_lists_brute_force, merge_two_sorted_lists_optimized
        return ['merge_two_sorted_lists', 'merge_two_sorted_lists_brute_force', 'merge_two_sorted_lists_optimized']
