...
def _auto_import_functions():
    ...
    try:
        ...
        from .invert_binary_tree import invert_binary_tree, invert_binary_tree_brute_force, invert_binary_tree_optimized
        return ['invert_binary_tree', 'invert_binary_tree_brute_force', 'invert_binary_tree_optimized']
