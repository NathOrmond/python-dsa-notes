...
def _auto_import_functions():
    ...
    try:
        ...
        from .diameter_of_binary_tree import diameter_of_binary_tree, diameter_of_binary_tree_brute_force, diameter_of_binary_tree_optimized
        return ['diameter_of_binary_tree', 'diameter_of_binary_tree_brute_force', 'diameter_of_binary_tree_optimized']
