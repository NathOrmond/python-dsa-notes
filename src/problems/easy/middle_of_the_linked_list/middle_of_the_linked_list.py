...
def middle_of_the_linked_list(head: Optional[ListNode]) -> Optional[ListNode]:
    """
    Main solution function for middle of the linked list.
    ...
    return middle_of_the_linked_list_iterative(head)


def middle_of_the_linked_list_brute_force(head: Optional[ListNode]) -> Optional[ListNode]:
    """
    Brute force approach for middle of the linked list.
...
def middle_of_the_linked_list_iterative(head: Optional[ListNode]) -> Optional[ListNode]:
    """
    Optimized approach for middle of the linked list.
