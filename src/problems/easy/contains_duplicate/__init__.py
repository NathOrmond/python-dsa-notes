...
def _auto_import_functions():
    ...
    try:
        ...
        from .contains_duplicate import contains_duplicate, contains_duplicate_brute_force, contains_duplicate_optimized
        return ['contains_duplicate', 'contains_duplicate_brute_force', 'contains_duplicate_optimized']
