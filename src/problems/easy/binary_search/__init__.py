...
def _auto_import_functions():
    ...
    try:
        ...
        from .binary_search import binary_search, binary_search_brute_force, binary_search_optimized
        return ['binary_search', 'binary_search_brute_force', 'binary_search_optimized']
