...
def first_bad_version(nums: List[int]) -> int:
    """
    Main solution function for first bad version.
    ...
    return first_bad_version_optimized(nums)


def first_bad_version_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for first bad version.
...
def first_bad_version_optimized(nums: List[int]) -> int:
    """
    Optimized approach for first bad version.
