...
def _auto_import_functions():
    ...
    try:
        ...
        from .first_bad_version import first_bad_version, first_bad_version_brute_force, first_bad_version_optimized
        return ['first_bad_version', 'first_bad_version_brute_force', 'first_bad_version_optimized']
