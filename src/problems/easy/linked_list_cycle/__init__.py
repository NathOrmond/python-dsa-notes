...
def _auto_import_functions():
    ...
    try:
        ...
        from .linked_list_cycle import linked_list_cycle, linked_list_cycle_brute_force, linked_list_cycle_optimized
        return ['linked_list_cycle', 'linked_list_cycle_brute_force', 'linked_list_cycle_optimized']
