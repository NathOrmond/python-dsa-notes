...
def _auto_import_functions():
    ...
    try:
        ...
        from .balanced_binary_tree import balanced_binary_tree, balanced_binary_tree_brute_force, balanced_binary_tree_optimized
        return ['balanced_binary_tree', 'balanced_binary_tree_brute_force', 'balanced_binary_tree_optimized']
