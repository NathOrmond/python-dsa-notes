...
def lowest_common_ancestor_of_a_binary_search_tree(nums: List[int], target: int) -> int:
    """
    Main solution function for lowest common ancestor of a binary search tree.
    ...
    return lowest_common_ancestor_of_a_binary_search_tree_recursive(nums)


def lowest_common_ancestor_of_a_binary_search_tree_brute_force(nums: List[int], target: int) -> int:
    """
    Brute force approach for lowest common ancestor of a binary search tree.
...
def lowest_common_ancestor_of_a_binary_search_tree_recursive(nums: List[int], target: int) -> int:
    """
    Optimized approach for lowest common ancestor of a binary search tree.
