...
def add_binary(nums: List[int]) -> int:
    """
    Main solution function for add binary.
    ...
    return add_binary_optimized(nums)


def add_binary_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for add binary.
...
def add_binary_optimized(nums: List[int]) -> int:
    """
    Optimized approach for add binary.
