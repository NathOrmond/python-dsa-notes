...
def _auto_import_functions():
    ...
    try:
        ...
        from .implement_queue_using_stacks import implement_queue_using_stacks, implement_queue_using_stacks_brute_force, implement_queue_using_stacks_optimized
        return ['implement_queue_using_stacks', 'implement_queue_using_stacks_brute_force', 'implement_queue_using_stacks_optimized']
