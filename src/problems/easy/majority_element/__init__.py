...
def _auto_import_functions():
    ...
    try:
        ...
        from .majority_element import majority_element, majority_element_brute_force, majority_element_optimized
        return ['majority_element', 'majority_element_brute_force', 'majority_element_optimized']
