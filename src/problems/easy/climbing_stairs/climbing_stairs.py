...
def climbing_stairs(nums: List[int]) -> int:
    """
    Main solution function for climbing stairs.
    ...
    return climbing_stairs_optimized(nums)


def climbing_stairs_brute_force(nums: List[int]) -> int:
    """
    Brute force approach for climbing stairs.
...
def climbing_stairs_optimized(nums: List[int]) -> int:
    """
    Optimized approach for climbing stairs.
