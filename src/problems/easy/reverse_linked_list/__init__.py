...
def _auto_import_functions():
    ...
    try:
        ...
        from .reverse_linked_list import reverse_linked_list, reverse_linked_list_brute_force, reverse_linked_list_optimized
        return ['reverse_linked_list', 'reverse_linked_list_brute_force', 'reverse_linked_list_optimized']
