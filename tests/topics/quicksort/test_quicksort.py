...
from topics.sorting.quicksort.quicksort import Solution
...
class TestQuickSort:
    ...
    def test_sorted_array(self):
        ...
        solution = Solution()
        result = solution.quick_sort(nums.copy())
        assert result == nums, "Sorted array should remain the same"
    ...
    def test_worst_case_performance(self):
        """Test worst-case scenario (sorted or reverse sorted)."""
        # Already sorted array
        sorted_nums = list(range(20))
        solution = Solution()
        result = solution.quick_sort(sorted_nums.copy())
        expected = sorted(sorted_nums)
        assert result == expected
