"""
Tests for Find All Anagrams In A String
"""

import pytest
from src.problems.easy.find_all_anagrams_in_a_string import find_all_anagrams_in_a_string, find_all_anagrams_in_a_string_brute_force


class TestFindAllAnagramsInAString:
    """Test cases for find_all_anagrams_in_a_string problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert find_all_anagrams_in_a_string(s = "anagram", t = "nagaram") == True
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = find_all_anagrams_in_a_string(test_case)
        #     result2 = find_all_anagrams_in_a_string_brute_force(test_case)
