...
import pytest
from src.problems.easy.number_of_islands import number_of_islands, number_of_islands_brute_force


class TestNumberOfIslands:
    """Test cases for number_of_islands problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert number_of_islands(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = number_of_islands(test_case)
        #     result2 = number_of_islands_brute_force(test_case)
