"""
Tests for Kth Smallest Element In A Bst
"""

import pytest
from src.problems.easy.kth_smallest_element_in_a_bst import kth_smallest_element_in_a_bst, kth_smallest_element_in_a_bst_brute_force


class TestKthSmallestElementInABst:
    """Test cases for kth_smallest_element_in_a_bst problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert kth_smallest_element_in_a_bst(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = kth_smallest_element_in_a_bst(test_case)
        #     result2 = kth_smallest_element_in_a_bst_brute_force(test_case)
