...
import pytest
from src.problems.easy.course_schedule import course_schedule, course_schedule_brute_force


class TestCourseSchedule:
    """Test cases for course_schedule problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert course_schedule(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = course_schedule(test_case)
        #     result2 = course_schedule_brute_force(test_case)
