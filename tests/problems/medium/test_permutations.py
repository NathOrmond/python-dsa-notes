...
import pytest
from src.problems.easy.permutations import permutations, permutations_brute_force
...
class TestPermutations:
    ...
    def test_main_function_basic(self):
        ...
        # Example: assert permutations(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = permutations(test_case)
        #     result2 = permutations_brute_force(test_case)
