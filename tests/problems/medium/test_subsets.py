...
import pytest
from src.problems.easy.subsets import subsets, subsets_brute_force
...
class TestSubsets:
    ...
    def test_main_function_basic(self):
        ...
        # Example: assert subsets(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = subsets(test_case)
        #     result2 = subsets_brute_force(test_case)
