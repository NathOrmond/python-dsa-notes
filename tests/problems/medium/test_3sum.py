...
import pytest
from src.problems.easy.3sum import 3sum, 3sum_brute_force
...
class Test3Sum:
    ...
    def test_main_function_basic(self):
        ...
        # Example: assert 3sum(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = 3sum(test_case)
        #     result2 = 3sum_brute_force(test_case)
