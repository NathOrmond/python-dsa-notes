"""
Tests for String To Integer Atoi
"""

import pytest
from src.problems.easy.string_to_integer_atoi import string_to_integer_atoi, string_to_integer_atoi_brute_force


class TestStringToIntegerAtoi:
    """Test cases for string_to_integer_atoi problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert string_to_integer_atoi(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = string_to_integer_atoi(test_case)
        #     result2 = string_to_integer_atoi_brute_force(test_case)
