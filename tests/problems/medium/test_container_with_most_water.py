...
import pytest
from src.problems.easy.container_with_most_water import container_with_most_water, container_with_most_water_brute_force


class TestContainerWithMostWater:
    """Test cases for container_with_most_water problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert container_with_most_water(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = container_with_most_water(test_case)
        #     result2 = container_with_most_water_brute_force(test_case)
