...
import pytest
from src.problems.easy.longest_substring_without_repeating_characters import longest_substring_without_repeating_characters, longest_substring_without_repeating_characters_brute_force


class TestLongestSubstringWithoutRepeatingCharacters:
    """Test cases for longest_substring_without_repeating_characters problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert longest_substring_without_repeating_characters(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = longest_substring_without_repeating_characters(test_case)
        #     result2 = longest_substring_without_repeating_characters_brute_force(test_case)
