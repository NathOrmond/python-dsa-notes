"""
Tests for Lowest Common Ancestor Of A Binary Search Tree
"""

import pytest
from src.problems.easy.lowest_common_ancestor_of_a_binary_search_tree import lowest_common_ancestor_of_a_binary_search_tree, lowest_common_ancestor_of_a_binary_search_tree_brute_force


class TestLowestCommonAncestorOfABinarySearchTree:
    """Test cases for lowest_common_ancestor_of_a_binary_search_tree problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert lowest_common_ancestor_of_a_binary_search_tree(nums = [-1, 0, 3, 5, 9, 12], target = 9) == 4
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = lowest_common_ancestor_of_a_binary_search_tree(test_case)
        #     result2 = lowest_common_ancestor_of_a_binary_search_tree_brute_force(test_case)
