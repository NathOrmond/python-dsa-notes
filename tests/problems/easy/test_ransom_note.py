"""
Tests for Ransom Note
"""

import pytest
from src.problems.easy.ransom_note import ransom_note, ransom_note_brute_force


class TestRansomNote:
    """Test cases for ransom_note problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert ransom_note(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = ransom_note(test_case)
        #     result2 = ransom_note_brute_force(test_case)
