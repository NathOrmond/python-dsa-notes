...
import pytest
from src.problems.easy.reverse_linked_list import reverse_linked_list, reverse_linked_list_brute_force
...
class TestReverseLinkedList:
    ...
    def test_main_function_basic(self):
        ...
        # Example: assert reverse_linked_list(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = reverse_linked_list(test_case)
        #     result2 = reverse_linked_list_brute_force(test_case)
