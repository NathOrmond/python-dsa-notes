"""
Tests for Majority Element
"""

import pytest
from src.problems.easy.majority_element import majority_element, majority_element_brute_force


class TestMajorityElement:
    """Test cases for majority_element problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert majority_element(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = majority_element(test_case)
        #     result2 = majority_element_brute_force(test_case)
