...
import pytest
from src.problems.easy.first_bad_version import first_bad_version, first_bad_version_brute_force


class TestFirstBadVersion:
    """Test cases for first_bad_version problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert first_bad_version(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = first_bad_version(test_case)
        #     result2 = first_bad_version_brute_force(test_case)
