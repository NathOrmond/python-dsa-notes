...
import pytest
from src.problems.easy.invert_binary_tree import invert_binary_tree, invert_binary_tree_brute_force
...
class TestInvertBinaryTree:
    ...
    def test_main_function_basic(self):
        ...
        # Example: assert invert_binary_tree(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = invert_binary_tree(test_case)
        #     result2 = invert_binary_tree_brute_force(test_case)
