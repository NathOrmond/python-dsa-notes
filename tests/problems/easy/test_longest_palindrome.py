"""
Tests for Longest Palindrome
"""

import pytest
from src.problems.easy.longest_palindrome import longest_palindrome, longest_palindrome_brute_force


class TestLongestPalindrome:
    """Test cases for longest_palindrome problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert longest_palindrome(s = "racecar") == True
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = longest_palindrome(test_case)
        #     result2 = longest_palindrome_brute_force(test_case)
