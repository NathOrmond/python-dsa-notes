"""
Tests for Maximum Profit In Job Scheduling
"""

import pytest
from src.problems.easy.maximum_profit_in_job_scheduling import maximum_profit_in_job_scheduling, maximum_profit_in_job_scheduling_brute_force


class TestMaximumProfitInJobScheduling:
    """Test cases for maximum_profit_in_job_scheduling problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert maximum_profit_in_job_scheduling(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = maximum_profit_in_job_scheduling(test_case)
        #     result2 = maximum_profit_in_job_scheduling_brute_force(test_case)
