...
import pytest
from src.problems.easy.basic_calculator import basic_calculator, basic_calculator_brute_force


class TestBasicCalculator:
    """Test cases for basic_calculator problem."""
    
    def test_main_function_basic(self):
        """Test main function with basic examples."""
        # TODO: Add basic test cases
        # Example: assert basic_calculator(nums = [1, 2, 3, 4, 5]) == TODO
        pass
    ...
    def test_approaches_consistent(self):
        ...
        #     result1 = basic_calculator(test_case)
        #     result2 = basic_calculator_brute_force(test_case)
